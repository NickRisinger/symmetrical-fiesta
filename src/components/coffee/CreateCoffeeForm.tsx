...
import RepairCostsList from './RepairCostsList';
...
const CreateCoffeeForm = ({
  ...
  const steps: Step[] = [
    ...
    },
    {
      id: 6,
      title: 'Доп. Расходы',
      content: <ExpenseList form={form} />,
    },
  ];

  return (
    <Paper shadow="sm" p="lg" h={'100%'} radius="md" withBorder>
      ...
      <Group justify="center" mt="xl">
        ...
        {currentStep === steps.length - 1 ? (
          <Button onClick={handelSubmitForm}>Расчитать план</Button>
        ) : (
          <Button
            onClick={() =>
